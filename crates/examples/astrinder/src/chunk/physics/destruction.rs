...
use crate::chunk::{CHUNK_PART_SIZE, IdCounter};
use crate::chunk::chunk::Chunk;
use crate::math::{hex_to_coord, hex_to_particle_index};
...
impl BreakPattern {
    ...
    pub fn into_chunk(&self, 
        ...
        Chunk::new(transform, velocity_transform, particles, part_id_counter, true, settings, physics_controller)
    }

    pub fn apply_to_chunk(&self, 
        chunk: &Chunk, 
        start_hex: IVec2, 
        part_id_counter: &mut IdCounter, 
        settings: Settings,
        ...
        let vel_transform = physics_controller.get_velocity(chunk);
